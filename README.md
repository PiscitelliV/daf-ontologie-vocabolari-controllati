...
- **Ontologie (Ontologies)**: contiene le ontologie OWL, serializzate in RDF/Turtle, RDF/XML e JSON-LD.

- **Vocabolari controllati (Controlled Vocabularies)**: include un elenco di vocabolari sviluppati, spesso anche a supporto delle ontologie. Alcuni vocabolari sono suddivisi per macro-temi, come trasparenza amministrativa, settore culturale, servizi pubblici, e altri.

## Catalogo e accesso

Le risorse semantiche di questo repository sono consultabili e organizzate in https://schema.gov.it - Il catalogo nazionale della sematica dei dati, che abilita l'interoperabilità semantica di dati tra pubbliche amministrazioni, consentendo lo scambio efficace di dati.

Tutte le ontologie e i vocabolari controllati del repository sono interrogabili tramite lo [SPARQL endpoint](https://schema.gov.it/sparql)

Consulta la [documentazione](https://wp-ndc-dev.apps.cloudpub.testedev.istat.it/strumenti/sparql-endpoint/#interroga-le-risorse-semantiche) dedicata dell'endpoint per ulteriori dettagli.

## Come contribuire

Nella [guida al catalogo](https://teamdigitale.github.io/dati-semantic-guida-ndc-docs/index.html) sono descritte le modalità per fruire e/o contribuire all’alimentazione dei contenuti semantici del repository e del catalogo.

Se sei nuovo nel mondo della semantica dei dati, e hai bisogno di un’**introduzione generale sul tema**, fai riferimento a [Introduzione alla semantica dei dati e del Web Semantico](https://teamdigitale.github.io/dati-semantic-doc-introduzione-semantica/)
...
</br>Invia una mail a info@schema.gov.it
